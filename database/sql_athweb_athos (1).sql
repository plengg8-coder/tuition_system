...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2026 at 10:41 AM
...
--
ALTER TABLE `ath_member`
  MODIFY `mem_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'รหัสสมาชิก';

--
-- AUTO_INCREMENT for table `ath_member_family`
--
ALTER TABLE `ath_member_family`
  MODIFY `fam_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'รหัสสมาชิกในครอบครัว';
...
--
ALTER TABLE `ath_tuition_request`
  MODIFY `req_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'รหัสคำขอเบิกค่าเล่าเรียน';
